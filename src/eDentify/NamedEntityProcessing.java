...
public class NamedEntityProcessing {
    ...
    public static void main(String[] args) {
      ...
      //Define which serialised classifier to use
      ...
      */
      ...
      //TODO: Fix the path var below
      String defaultLocation = System.getProperty("user.dir");
      Path path = Paths.get("/Users/pnagashima/Projects/Uni Y3/eDentify/src/eDentify/preprocess/results.txt");
      
      if (args.length > 1) {
        String fileContents;
		try {
			fileContents = IOUtils.slurpFile(args[1]);
    	  ...
    	  //TODO: Make sure this outputs to the clusteredResults.txt file
